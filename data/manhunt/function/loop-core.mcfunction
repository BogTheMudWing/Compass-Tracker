...
## Menu tellraw
execute as @a[scores={manhunt-options=1..}] run tellraw @s [{"text":"\n"},{"text":"- Manhunt Settings -\n","color":"red","bold":true},{"text":"\n> Countdown Timer\n","color":"white","bold":false},{"text":"Set the number of ticks (1/20th of a second) to wait before hunters can begin.\n","color":"gray","bold":false},{"text":"[","color":"dark_gray"},{"score":{"name":".countdown","objective":"manhunt-options"},"color":"gray","bold":false,"underlined":true,"click_event":{"action":"suggest_command","command":"/trigger Countdown set "}},{"text":" ticks","color":"gray","underlined":true,"click_event":{"action":"suggest_command","command":"/trigger Countdown set "}},{"text":"]\n","color":"dark_gray"},{"text":"\n> Runner Lives\n","color":"white","bold":false},{"text":"Set the number of lives runners are granted. Set to 0 for infinite.\n","color":"gray","bold":false},{"text":"[","color":"dark_gray"},{"score":{"name":".lives","objective":"manhunt-options"},"color":"gray","bold":false,"underlined":true,"click_event":{"action":"suggest_command","command":"/trigger Lives set "}},{"text":" lives","color":"gray","underlined":true,"click_event":{"action":"suggest_command","command":"/trigger Lives set "}},{"text":"]","color":"dark_gray"},{"text":"\n\n> Compass feedback","color":"white"},{"text":"\nWhether to show if the compass can track a player or not.","color":"gray"}]
execute as @a[scores={manhunt-options=1..}] if score .compass-feedback manhunt-options matches 1 run tellraw @s [{"text":"[","color":"dark_gray"},{"text":"Enabled","color":"green","underlined":true,"click_event":{"action":"run_command","command":"/trigger manhunt-options set 2"}},{"text":"]","color":"dark_gray"}]
execute as @a[scores={manhunt-options=1..}] unless score .compass-feedback manhunt-options matches 1 run tellraw @s [{"text":"[","color":"dark_gray"},{"text":"Disabled","color":"red","underlined":true,"click_event":{"action":"run_command","command":"/trigger manhunt-options set 3"}},{"text":"]","color":"dark_gray"}]
...
execute as @a[scores={manhunt-options=1..}] if score .endgame manhunt-options matches 1 run tellraw @s [{"text":"[","color":"dark_gray"},{"text":"Enabled","color":"green","underlined":true,"click_event":{"action":"run_command","command":"/trigger manhunt-options set 4"}},{"text":"]","color":"dark_gray"}]
execute as @a[scores={manhunt-options=1..}] unless score .endgame manhunt-options matches 1 run tellraw @s [{"text":"[","color":"dark_gray"},{"text":"Disabled","color":"red","underlined":true,"click_event":{"action":"run_command","command":"/trigger manhunt-options set 5"}},{"text":"]","color":"dark_gray"}]
## Reset trigger
